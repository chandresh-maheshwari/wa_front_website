      ...
      try {
        ...
        if (response.status === 200 && response.vehicle) {
          ...
          setFormData({
            ...
            user_tip_id: vehicle.user_tip_id || "",
            vehicle_description: vehicle.vehicle_description || "",
            ...
            vehicle_license_expire_date:
              vehicle.vehicle_license_expire_date || "",
            vehicle_address_1: vehicle.vehicle_address_1 || "",
            vehicle_address_2: vehicle.vehicle_address_2 || "",
            vehicle_address_3: vehicle.vehicle_address_3 || "",
            vehicle_address_4: vehicle.vehicle_address_4 || "",
            vehicle_postcode: vehicle.vehicle_postcode || "",
            vehicle_owner: vehicle.vehicle_owner || "",
            vehicle_emissions: vehicle.vehicle_emissions || "",
            vehicle_ppm: vehicle.vehicle_ppm || "",
            vehicle_load: vehicle.vehicle_load || "",
            vehicle_tare_weight: vehicle.vehicle_tare_weight || "",
            fuel_type_id: vehicle.fuel_type_id || "",
            driver_name: vehicle.driver_name || "",
          });
