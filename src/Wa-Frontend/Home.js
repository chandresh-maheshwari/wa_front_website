                ...
                <div className={`col-lg-4`} id={`card${index + 1}`} key={card.id}>
                    ...
                    <div className={`card${index + 1} card `}>
                        ...
                        <div className={`card${index + 1}-text`}>
                            {[card.Cardtext1, card.Cardtext2, card.Cardtext3, card.Cardtext4, card.Cardtext5].map((text, i) => (
                                text && (
                            ...
                            {card.Cardtext1 || card.Cardtext2 || card.Cardtext3 || card.Cardtext4 || card.Cardtext5 ? <div className="card-liner-inside"></div> : null}
                        </div>
                        <div className={`card${index + 1}-sec-2-text`}>
                            ...
                            {card.Cardtextlight1 ? <div className="card-liner-inside-2"></div> : null}
                            <div className={`card-${index + 1}-sec-3`}>
                                {card.Montlyfeetext && <p className={`card${index + 1}-sec-3-text1`}>{card.Montlyfeetext}</p>}
                                {[card.Montlyfeecardtext1, card.Montlyfeecardtext2].map((text, i) => (
                                    text && (
